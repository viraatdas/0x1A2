...
export default function SignupPage() {
  ...
  const handleSignup = async (e: React.FormEvent) => {
    ...
    try {
      // TODO: Validate invite code first
    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-900 via-blue-900 to-indigo-900 flex items-center justify-center px-4">
      ...
      >
        ...
        <div className="mb-8">
          ...
          <h2 className="text-2xl font-bold text-white text-center">Join the teapot</h2>
          <p className="text-gray-300 text-center mt-2">You'll need an invite code</p>
        </div>
        ...
        <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-8">
          <form onSubmit={handleSignup} className="space-y-6">
            <div>
              <label htmlFor="inviteCode" className="block text-white mb-2">
                Invite Code
              </label>
              <input
                type="text"
